...
abstract class HexGuideModDependenciesExtension(private val project: Project) {
...
val extension = extensions.create<HexGuideModDependenciesExtension>("hexguideModDependencies")
