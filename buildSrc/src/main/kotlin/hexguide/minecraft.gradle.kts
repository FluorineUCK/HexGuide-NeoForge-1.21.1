...
loom {
    ...
    accessWidenerPath = project(":common").file("src/main/resources/hexguide.accesswidener")

    mixin {
        // the default name includes both archivesName and the subproject, resulting in the platform showing up twice
        // default: hexguide-common-common-refmap.json
        // fixed:   hexguide-common.refmap.json
