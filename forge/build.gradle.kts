...
loom {
    forge {
        ...
        mixinConfig(
            "hexguide-common.mixins.json",
            "hexguide-forge.mixins.json",
        )
    }
    ...
    runs {
        for ((platform, outputProject) in arrayOf(
            ...
            register("${platform}Datagen") {
                ...
                property("hexguide.apply-datagen-mixin", "true")
                property("hexguide.$platform-datagen", "true")
            }
        }
    }
}

hexguideModDependencies {
