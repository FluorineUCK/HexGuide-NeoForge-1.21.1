...
import hexdoc_hexguide

from .__gradle_version__ import FULL_VERSION, MOD_ID, MOD_VERSION
from .__version__ import PY_VERSION


class HexGuidePlugin(ModPluginImpl):
    @staticmethod
    @hookimpl
    def hexdoc_mod_plugin(branch: str) -> ModPlugin:
        return HexGuideModPlugin(branch=branch)


class HexGuideModPlugin(ModPluginWithBook):
    @property
    @override
    def modid(self) -> str:
        return MOD_ID
    ...
    def jinja_template_root(self) -> tuple[Package, str]:
        return hexdoc_hexguide, "_templates"
