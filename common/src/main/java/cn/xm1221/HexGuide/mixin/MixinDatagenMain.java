...
public abstract class MixinDatagenMain {
    ...
    private static void hexguide$systemExitAfterDatagenFinishes(String[] strings, Operation<Void> original) {
        try {
            original.call((Object) strings);
        } catch (Throwable throwable) {
            HexGuide.LOGGER.error("Datagen failed!", throwable);
            System.exit(1);
        }
        HexGuide.LOGGER.info("Datagen succeeded, terminating.");
        System.exit(0);
    }
}
