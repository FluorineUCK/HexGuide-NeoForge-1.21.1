...
public class PageComponentText extends BookPage {
    ...
    private Component buildComponent(JsonElement elem) {
        ...
        try {
            Component c = Component.Serializer.fromJson(resolved);
            ...
            } else if (c.getContents() instanceof net.minecraft.network.chat.contents.LiteralContents lc
    ...
    public void render(GuiGraphics graphics, int mouseX, int mouseY, float pticks) {
        if (textRender != null) textRender.render(graphics, mouseX, mouseY);
